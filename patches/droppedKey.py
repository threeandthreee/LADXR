...
notSpecialSideView:
        ...
        ldh  a, [hActiveEntitySpriteVariant] ; Load active sprite variant to see if this is just a normal small key
        cp   $1A
        jr   z, isAKey
...
isAKey:
    ...
    rom.banks[0x3E][0x3800 + 0x300] = 0x89
